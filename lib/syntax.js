  ...
  Syntax = class Syntax {
    ...
    * TID (the lexeme's name) will default to the part after the prefix
    ...
    constructor(cfg) {
      ...
      this.cfg.prefix = 'lx_';
      this.cfg.import_prefix = this.cfg.prefix;
      this.cfg.export_prefix = this.cfg.prefix;
      this.cfg._import_matcher = /^lx_(?<tid>.+)$/;
      //.......................................................................................................
    ...
    _compile_lexemes({target}) {
      ...
      for (i = 0, len = ref.length; i < len; i++) {
        xtid = ref[i];
        if ((match = xtid.match(this.cfg._import_matcher)) == null) {
          continue;
        }
        ({tid} = match.groups);
