(function() {
  'use strict';
  var C, DATOM, E, GUY, Interlex_base, Ltsort, _CRX, _X, alert, compose, copy_regex, debug, echo, equals, get_base_types, help, info, inspect, jump_symbol, lets, log, misfit, new_datom, plain, praise, rpr, urge, warn, whisper;
  ...
  //===========================================================================================================
  Interlex_base = class Interlex_base {
    //---------------------------------------------------------------------------------------------------------
    constructor(cfg) {
...
/* NOTE avoiding shorthand for clarity */      ref = entry.lexemes;
  ...
  //===========================================================================================================
  module.exports = {Interlex_base, compose};

}).call(this);

//# sourceMappingURL=interlex-base.js.map