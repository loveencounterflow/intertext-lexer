(function() {
  'use strict';
  var $, $010_lexing, $020_consolidate, $030_dentchgs, $040_blocks, $window, DATOM, GUY, Outliner, Transformer, alert, debug, echo, get_base_types, help, info, inspect, lets, log, misfit, new_datom, new_prelexer, plain, praise, rpr, select, transforms, urge, warn, whisper,
  ...
  $010_lexing = class $010_lexing extends Transformer {
    ...
    constructor() {
      ...
      GUY.props.hide(this, '_lexer', new_prelexer());
      return void 0;
    }
  ...
  $030_dentchgs = (function() {
    ...
    class $030_dentchgs extends $020_consolidate {
      ...
      $add_start_and_stop() {
        boundMethodCheck(this, $030_dentchgs);
  ...
  //===========================================================================================================
  $040_blocks = class $040_blocks extends $030_dentchgs {
    constructor() {
      super(...arguments);
      //---------------------------------------------------------------------------------------------------------
  ...
  //===========================================================================================================
  this.Outliner = Outliner = (function() {
    class Outliner extends $040_blocks {};

    Outliner.$010_lexing = $010_lexing;

    Outliner.$020_consolidate = $020_consolidate;

    Outliner.$030_dentchgs = $030_dentchgs;

    Outliner.$040_blocks = $040_blocks;
