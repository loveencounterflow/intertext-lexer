(function() {
  'use strict';
  var GUY, Transformer, _Preparser, _new_prelexer, alert, debug, echo, get_base_types, help, info, inspect, lets, log, misfit, plain, praise, rpr, urge, warn, whisper,
  ...
  //===========================================================================================================
  _Preparser = class _Preparser extends Transformer {
    //---------------------------------------------------------------------------------------------------------
    constructor() {
      super();
      //---------------------------------------------------------------------------------------------------------
    ...
    $parse() {
      var parse;
      boundMethodCheck(this, _Preparser);
      return parse = (source, send) => {
        var ref, results, token;
        debug('^534^', source);
        debug('^534^', this._lexer);
