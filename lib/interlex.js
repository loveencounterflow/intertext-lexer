...
/* NOTE avoiding shorthand for clarity */      ref = entry.lexemes;
    ...
    //---------------------------------------------------------------------------------------------------------
    _start(source = null) {
      var base, base1, base2, base3, entry, mode, ref, ref1, ref2, ref3, ref4;
      ...
      if (this.cfg.linewise) {
        ...
        if ((base2 = this.state).offset == null) {
          base2.offset = this.cfg.offset;
        }
        if ((base3 = this.state).eol == null) {
          base3.eol = '';
        }
      }
      return null;
    ...
    _new_token(tid, value, length, x = null, lexeme = null) {
      var jump, lnr, mode, ref, start, stop;
      start = this.cfg.linewise ? this.state.offset + this.state.prv_last_idx : this.state.prv_last_idx;
    ...
    * _walk_text_lines(cfg) {
    ...
    step() {
      ...
      var after, before, center, left, lexeme, match, mid, ref, ref1, ref2, ref3, right, token;
      //.......................................................................................................
      ...
      if (this.state.prv_last_idx >= this.state.source.length) {
        ...
        if (this.cfg.linewise) {
          this.state.offset += ((ref = (ref1 = this.state.source) != null ? ref1.length : void 0) != null ? ref : 0) + ((ref2 = (ref3 = this.state.eol) != null ? ref3.length : void 0) != null ? ref2 : 0);
        }
        return token;
      }
      //.......................................................................................................
