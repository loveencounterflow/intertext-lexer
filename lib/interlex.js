(function() {
  ...
  Interlex = class Interlex {
    ...
    add_lexeme(cfg) {
      ...
      lexeme.type_of_value = this.types.type_of(entry.value);
      lexeme.type_of_empty_value = this.types.type_of(entry.empty_value);
...
/* NOTE avoiding shorthand for clarity */      ref = entry.lexemes;
    ...
    //---------------------------------------------------------------------------------------------------------
    _start(source = null) {
      var base, base1, base2, base3, base4, entry, mode, ref, ref1, ref2, ref3, ref4;
      ...
      if (this.cfg.linewise) {
        if ((base3 = this.state).lnr == null) {
          base3.lnr = this.cfg.lnr - 1;
        }
    ...
    _new_token(tid, value, length, x = null, lexeme = null) {
      var R, jump, lnr, mode, ref, source, start, stop;
      ...
      //.......................................................................................................
      this._set_entry_value(R, lexeme, value);
      //.......................................................................................................
    ...
    _set_entry_value(entry, lexeme, value) {
      if (((lexeme != null ? lexeme.empty_value : void 0) != null) && ((entry.value == null) || (entry.value === ''))) {
        switch (lexeme.type_of_empty_value) {
          case 'text':
            entry.value = lexeme.empty_value;
            break;
          case 'function':
            entry.value = lexeme.empty_value.call(this, entry);
            break;
          default:
        ...
        switch (lexeme.type_of_value) {
          case 'text':
            entry.value = lexeme.value;
            break;
          case 'function':
            entry.value = lexeme.value.call(this, entry);
            break;
          default:
    ...
    * _walk_text_lines(cfg) {
    ...
    add_catchall_lexeme(cfg) {
      var entry, mode, pattern, tid;
      ({mode, tid} = this.types.create.ilx_add_catchall_lexeme_cfg(cfg));
      if (mode == null) {
        mode = this.base_mode;
      }
      if ((entry = this.registry[mode]) == null) {
    ...
    add_reserved_lexeme(cfg) {
      var entry, mode, pattern, tid;
      ({mode, tid} = this.types.create.ilx_add_reserved_lexeme_cfg(cfg));
      if (mode == null) {
        mode = this.base_mode;
      }
      if ((entry = this.registry[mode]) == null) {
