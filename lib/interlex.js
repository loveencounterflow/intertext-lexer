...
/* NOTE avoiding shorthand for clarity */      ref = entry.lexemes;
    ...
    _token_and_lexeme_from_match(match) {
      var atrs, key, lexeme, ref, token, token_tid, token_value, value;
      atrs = null;
      ref = match.groups;
      for (key in ref) {
        value = ref[key];
        ...
        if (key.startsWith(this._metachr)) {
          ...
          (atrs != null ? atrs : atrs = {})[key] = value === '' ? null : value;
        }
      }
      lexeme = this.registry[this.state.mode].lexemes[token_tid];
      token = this._new_token(token_tid, token_value, match[0].length, atrs, lexeme);
      return {token, lexeme};
    }
    ...
    * _walk_text_lines(cfg) {
    ...
    step() {
      ...
      if (token != null) {
        border = null;
        //.....................................................................................................
        if (this.cfg.border_tokens && (this.state.mode !== prv_mode)) {
          border = this._new_token('$border', this.cfg.border_value, 0, {
            prv: prv_mode,
            nxt: this.state.mode
          });
        }
        //.....................................................................................................
        if ((border != null) && token.mode !== prv_mode) {
          border = lets(border, function(border) {
