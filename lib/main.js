(function() {
  'use strict';
  var E, GUY, Interlex, Interlex_base, alert, compose, copy_regex, debug, echo, equals, get_base_types, help, info, inspect, jump_symbol, log, misfit, plain, praise, rpr, urge, warn, whisper;
  ...
  ({Interlex_base, compose} = require('./interlex-base'));

  //===========================================================================================================
  Interlex = class Interlex extends Interlex_base {
    /*
  ...
  //===========================================================================================================
  module.exports = {Interlex, Interlex_base, compose};
