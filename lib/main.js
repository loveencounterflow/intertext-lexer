(function() {
  ...
  Interlex = class Interlex {
    ...
    _token_from_match(match) {
      var key, ref, token_tid, token_value, value, x;
      x = null;
      ref = match.groups;
      for (key in ref) {
        value = ref[key];
      ...
      return this._new_token(token_tid, token_value, match[0].length, x);
    }
    ...
    * walk(source) {
      ...
      while (true) {
        ...
        lexeme = this.registry[this.state.mode].lexemes[token.tid];
        yield token;
        //.....................................................................................................
        if (lexeme.push != null) {
