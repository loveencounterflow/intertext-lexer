(function() {
  'use strict';
  var C, DATOM, GUY, Interlex, _CRX, _X, alert, compose, copy_regex, debug, echo, equals, get_base_types, help, info, inspect, jump_symbol, k, log, misfit, plain, praise, rpr, urge, warn, whisper;
  ...
  debug('^535^', DATOM.new_datom('^foo'));

  debug('^535^', DATOM.new_datom('^foo', 42));

  debug('^535^', DATOM.fresh_datom('^foo', 42));

  debug('^535^', DATOM.stamp(DATOM.fresh_datom('^foo', 42)));
